...
export const metadata: Metadata = {
  ...
  description: 'K-Tech is a student-driven creative tech club exploring 3DCG, web development, AI, and media art. Join us to turn your passion into real-world innovation.',
  keywords: [
    'K-Tech',
    'Ritsumei',
    'Creative Technology',
  ...
  openGraph: {
    ...
    description: 'Explore cutting-edge creativity with K-Tech — where students turn ideas into impact through technology.',
